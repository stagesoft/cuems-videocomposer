/* cuems-videocomposer - shared header file
 *
 * Copyright (C) 2024 stagelab.coop
 * Ion Reguera <ion@stagelab.coop>
 *
 * This program is partially based on xjadeo code.
 * See individual source files for xjadeo copyright information.
 */
#ifndef CUEMS_VIDEOCOMPOSER_H
...
#else
# define FONT_FILE SHAREDIR "/cuems_videocomposer/ArdourMono.ttf"
#endif
